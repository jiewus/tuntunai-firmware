...
囤囤AI的底层对话能力仍然依赖小智（xiaozhi），因此首次使用时请先完成小智平台的设备绑定，
再执行下方囤囤AI绑定流程；顺序颠倒或只绑囤囤AI会导致语音会话链路不完整。

在**小智平台绑定设备时，音色请选择「龙婉 女」**：

- 囤囤AI 相关的天气、备忘录、通知等所有播报均以「龙婉 女」音色克隆而来；
- 选择该音色可保证小智对话与囤囤AI各功能播报的发音保持一致，体验最自然；
- 若选择其它音色，小智对话与囤囤AI播报会出现两种人声，音色不统一。

完成小智绑定并确认可正常对话后，再继续下面的囤囤AI绑定步骤。
